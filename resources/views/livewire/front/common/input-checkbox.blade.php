<div>
    <div class="row">
        <div class="col-12 mb-2 text-left">
            ...
            <input type="checkbox" class="form-check-input" wire:model="typecheckbox" value="{{ $item->option_value }}"
                name="{{ $in_data->input_name }}" id="{{ $in_data->inputType->tag_name }}{{ $in_data->id }}{{$key}}"
