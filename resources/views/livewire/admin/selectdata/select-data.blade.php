                        ...
                        <table id="dataTable" class="table table-striped table-bordered">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort" wire:click="columnSortOrder('select_title')">Select Title {!! $sortLink !!}
                                    </th>
                                    </th>
                                    <th>Action</th>
                 ...
                 <div class="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                       ...
                       <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z" />
                        ...
                        <h2 class="text-2xl font-bold mb-4">{{ $sdId ? 'Edit' : 'Create' }} {{$heading}}</h2>
                        <form  wire:submit.prevent="{{ $sdId ? 'update' : 'store' }}">
                            <div class="mb-4">
                                <label for="select_title" class="block text-gray-700 font-bold mb-2">Select Title</label>
                                <input type="text" wire:model="select_title" id="select_title" class="form-control" placeholder="Enter Select Title">
                                @error('select_title') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
