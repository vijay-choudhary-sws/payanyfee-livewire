                ...
                <div class="card-body">
                   ...
                   <div class="fixed inset-0 flex items-center justify-center z-50">
                      ...
                      <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                         ...
                         <h2 class="text-2xl font-bold mb-4">{{ $ptcId ? 'Edit' : 'Create' }} {{$heading}}</h2>
                         <form  wire:submit.prevent="{{ $ptcId ? 'update' : 'store' }}">
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                               <label for="name" class="block text-gray-700 font-bold mb-2">Course Id</label>
                               <input type="number" wire:model="course_id" id="course_id" class="form-control" placeholder="Enter Course Id">
