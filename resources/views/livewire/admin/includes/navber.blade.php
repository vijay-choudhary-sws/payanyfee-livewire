<div class="sidebar-wrapper" data-simplebar="init">
                        ...
                        <ul class="metismenu mm-show" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.schools') }}" wire:navigate class=""
                                            aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.school-programs') }}" wire:navigate class=""
                                            aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.school-program-type') }}" wire:navigate class=""
                                            aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.student-registrations') }}" wire:navigate
                                            class="" aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.payment-type-confrence') }}" wire:navigate
                                            class="" aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.select-datas') }}" wire:navigate class=""
                                            aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.gsts') }}" wire:navigate class=""
                                            aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    <li>
                                        <a href="{{ route('admin.paymentsettings') }}" wire:navigate class=""
                                            aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                                            <div class="menu-title">Payment Setting List</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.paymentsettings.paymentList',0) }}" wire:navigate class=""
                                            aria-expanded="true">
                                            <div class="parent-icon"><i class="bx bx-category"></i>
                                            </div>
                            ...
                            <li>
                                <a href="{{ route('admin.paymentgetways') }}" wire:navigate class=""
                                    aria-expanded="true">
                                    <div class="parent-icon"><i class="bx bx-category"></i>
                                    </div>
                                    <div class="menu-title">Payment Getways</div>
                                </a>
                            </li>
    ...
    <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
        <div class="simplebar-scrollbar simplebar-visible"
            style="height: 78px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
    </div>
</div>
