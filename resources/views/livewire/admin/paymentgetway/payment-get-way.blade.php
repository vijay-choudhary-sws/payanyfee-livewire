                        ...
                        <div class="row">
                            <div class="col-8">
                                <form wire:submit.prevent="applyFilter" >
                                    ...
                                    <div class="px-2">
                                        <button type="submit" class="btn bg-blue-500 hover:bg-blue-700 text-white font-bold">Apply</button>
                                    </div>
                                    @if($filterApplied)
                                        <div class="px-2">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-9"></div>
                        <div class="col-3">
                            <a href="javascript:void(0);" class="btn ExportReporttoExcel" wire:click="exportToExcel" style="font-size: 9px;">
                                <svg class="svg-inline--fa fa-file-export fa-w-18" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="file-export" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                ...
                                @if ($paymentgateways->count())
                                    @foreach ($paymentgateways as $ptc)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button style="font-size: 12px;" wire:click="status_update({{ $ptc->id }})" class="btn bg-blue-500 hover:bg-blue-700 text-white font-bold " onclick="return confirm('Are you sure you want to change this course status?');">
                                                @if($ptc->status == 1) Inactive @else Active @endif
                                                </button>
                                             </td>
                                            <td>
                                            ...
                                            wire:click="edit({{ $ptc->id }})"  title="Edit {{ $heading }}"><i class="bx bx-edit"></i></button>
