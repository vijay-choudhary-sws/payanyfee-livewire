                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 mb-1">
                                        <label for="input_name" class="block text-gray-700 font-bold mb-2">Input
                                            Name</label>
                                        <input type="text" wire:model="input_name" id="input_name"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" wire:model="placeholder" id="placeholder"
                                            class="form-control" placeholder="Enter Name">
                                        @error('placeholder')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-6 mb-1">
                                        <label for="input_type" class="block text-gray-700 font-bold mb-2">Input
                                            Type</label>
                                        <select class="form-control single-select" id="input_type"
                                            wire:model="input_type" wire:change="isOption">
                                    ...
                                    <div class="col-6 mb-4">
                                        <label for="is_required"
                                            class="block text-gray-700 font-bold mb-2">Required</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 py-4">
                                    <button class="btn btn-primary"
                                        @if ($showSaveButton) wire:click="SettingWithGetway"
                                    @else
