<section>
    <div class="page-wrapper">
        <div class="page-content">
            ...
            @if ($showEditModal)
            <div class="modal-body" id="navbar-example">
                <div class="fixed inset-0 flex items-center justify-center z-50">
                    <div class="absolute inset-0 bg-black opacity-50"></div>
                    <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2 overflow-auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-4">
                                <label for="is-custom" class="block text-gray-700 font-bold mb-2">Is
                                    Custom</label>
                                <select class="form-control single-select" id="is-custom" wire:model="selectType"
                                    wire:change="isCustom">
                                    <option value="1">Yes</option>
                            ...
                            <div class="col-6 mb-4">
                                <label for="selectdata" class="block text-gray-700 font-bold mb-2">Input Select
                                    Data</label>
                                <select class="form-control single-select" id="selectdata" wire:model="selectdata">
                            ...
                            <div class="col-6 mb-4">
                                <label for="is_multiple_required" class="block text-gray-700 font-bold mb-2">Is Multiple
                                    Required</label>
                                <select class="form-control single-select" id="is_multiple_required"
                                    wire:model="is_multiple_required" wire:change="isMultiple">
                                    <option value="" selected>--select--</option>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>

                                </select>
                                @error('is_multiple_required')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-6 mb-4">
                                <label for="amountc" class="block text-gray-700 font-bold mb-2">Amount Change</label>
                                <select class="form-control single-select" id="amountc" wire:model="amountc">
                                    <option value="" selected>--select--</option>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                            ...
                            <table class="table table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><button class="btn text-white btn-info btn-sm"
                                                wire:click.prevent="multiadd({{ $i }})" wire:loading.attr="disabled"
                                                wire:target="multiadd">Add
                                                Row</button>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($multioption as $key => $value)
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Enter Option Name"
                                                    wire:model="multioptionname.{{ $value }}">
                                                @error('multioptionname.' . $value)
                                                <span class="text-danger error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Enter option multioptionlabel"
                                                    wire:model="multioptionlabel.{{ $value }}">
                                                @error('multioptionlabel.' . $value)
                                                <span class="text-danger error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <button class="btn btn-danger btn-sm"
                                                wire:click.prevent="multiremove({{ $key }})" wire:loading.attr="disabled"
                                                wire:target="multiremove">Remove</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 py-4">
                                    <button class="btn btn-primary" @if ($showSaveButton) wire:click="SettingWithGetway"
                                        @else disabled @endif>save</button>
                                </div>
