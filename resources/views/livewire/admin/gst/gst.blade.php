                ...
                <div class="card-body">
                   ...
                   <div class="fixed inset-0 flex items-center justify-center z-50">
                      ...
                      <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                         ...
                         <h2 class="text-2xl font-bold mb-4">{{ $gstId ? 'Edit' : 'Create' }} {{$heading}}</h2>
                         <form  wire:submit.prevent="{{ $gstId ? 'update' : 'store' }}">
                            <div class="mb-4">
